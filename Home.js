...
const Home = ({navigation}) => {
  ...
  const categories = ['POPULAR', 'QUALITY', 'NEW IN', 'LOW PRICES'];
    ...
    <SafeAreaView
      ...
      <View style={style.header}>
        <View>
          ...
          <Text style={{fontSize: 38, color: '#F52A2A', fontWeight: 'bold'}}>
            DREAM SHOP
          </Text>
        </View>
